   ...
   jobs:
     opencode:
       ...
       steps:
          ...
          - name: Run opencode
           uses: trentbrew/trellis-studio/github@latest
           env:
...
This is an early release. If you encounter issues or have feedback, please create an issue at https://github.com/trentbrew/trellis-studio/issues.
