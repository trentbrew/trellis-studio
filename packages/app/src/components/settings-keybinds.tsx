...
type GroupKey =
  ...
  | "settings.shortcuts.group.editor"
  | "settings.shortcuts.group.file"
  | "settings.shortcuts.group.view"
  | "settings.shortcuts.group.app"
...
const groupKey: Record<KeybindGroup, GroupKey> = {
  ...
  Editor: "settings.shortcuts.group.editor",
  File: "settings.shortcuts.group.file",
  View: "settings.shortcuts.group.view",
  App: "settings.shortcuts.group.app",
}
...
function groupFor(id: string): KeybindGroup {
  ...
  if (id.startsWith("file.") || id.startsWith("fileTree.") || id.startsWith("folder.")) return "File"
  if (id.startsWith("prompt.")) return "Prompt"
  if (id.startsWith("editor.")) return "Editor"
  if (id.startsWith("view.")) return "View"
  if (id.startsWith("app.")) return "App"
  if (id.startsWith("tab.")) return "Navigation"
  if (
