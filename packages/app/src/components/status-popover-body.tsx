...
const useMcpToggleMutation = (sync: ReturnType<typeof useSyncOptional>) => {
  const sdk = useSDK()
  const language = useLanguage()

  return useMutation(() => ({
    mutationFn: async (name: string) => {
      if (!sync) throw new Error(language.t("common.requestFailed"))
...
export function StatusPopoverBody(props: { shown: Accessor<boolean> }) {
  ...
  const toggleMcp = useMcpToggleMutation(sync)
