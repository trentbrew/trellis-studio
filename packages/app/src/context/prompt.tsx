...
export interface EntityPart extends PartBase {
  type: "entity"
  entityType: string
  entityId: string
  /** Human-readable label for composer display; machine ref stays in `content`. */
  label?: string
}
...
export type ContentPart = TextPart | FileAttachmentPart | AgentPart | EntityPart | ImageAttachmentPart
...
function isPartEqual(partA: ContentPart, partB: ContentPart) {
  switch (partA.type) {
    ...
    case "entity":
      return partB.type === "entity" && partA.entityType === partB.entityType && partA.entityId === partB.entityId
    case "image":
...
function clonePart(part: ContentPart): ContentPart {
  ...
  if (part.type === "entity") return { ...part }
  return {
    ...part,
