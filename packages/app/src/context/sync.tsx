...
export { applyOptimisticAdd, applyOptimisticRemove, mergeOptimisticPage } from "./sync-optimistic"
  ...
  init: () => {
    ...
    const loadMessages = async (input: {
      ...
      try {
        ...
        console.error(`Failed to load messages for session ${input.sessionID}:`, err)
      } finally {
        setMeta(
          produce((draft) => {
