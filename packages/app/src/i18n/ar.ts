export const dict = {
  ...
  "session.tab.track": "تتبع",
  "session.tab.code": "كود",
  ...
  "session.fileTree.newFile": "ملف جديد",
  "session.fileTree.newFolder": "مجلد جديد",
  "session.fileTree.expandAll": "توسيع الكل",
  "session.fileTree.collapseAll": "طي الكل",
  "session.fileTree.refresh": "تحديث",
