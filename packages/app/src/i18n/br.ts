export const dict = {
  ...
  "session.tab.track": "Rastreamento",
  ...
  "session.fileTree.newFile": "Novo arquivo",
  "session.fileTree.newFolder": "Nova pasta",
  "session.fileTree.expandAll": "Expandir tudo",
  "session.fileTree.collapseAll": "Recolher tudo",
  "session.fileTree.refresh": "Atualizar",
