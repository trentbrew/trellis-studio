export const dict = {
  ...
  "session.fileTree.newFile": "Nova datoteka",
  "session.fileTree.newFolder": "Nova mapa",
  "session.fileTree.expandAll": "Proširi sve",
  "session.fileTree.collapseAll": "Skupi sve",
  "session.fileTree.refresh": "Osvježi",
