export const dict = {
  ...
  "session.fileTree.newFile": "Ny fil",
  "session.fileTree.newFolder": "Ny mappe",
  "session.fileTree.expandAll": "Udvid alle",
  "session.fileTree.collapseAll": "Fold alle sammen",
  "session.fileTree.refresh": "Opdater",
