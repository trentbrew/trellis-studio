...
export const dict = {
  ...
  "session.fileTree.newFile": "Neue Datei",
  "session.fileTree.newFolder": "Neuer Ordner",
  "session.fileTree.expandAll": "Alle aufklappen",
  "session.fileTree.collapseAll": "Alle zuklappen",
  "session.fileTree.refresh": "Aktualisieren",
