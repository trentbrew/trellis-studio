export const dict = {
  ...
  "command.settings.shortcuts": "Open keyboard shortcuts",
  ...
  "command.folder.new": "New folder",
  "command.file.open": "Open file",
  "command.file.findInFiles": "Find in files",
  ...
  "command.editor.replace": "Replace",
  "command.editor.gotoLine": "Go to line",
  "command.editor.foldAll": "Fold all",
  "command.editor.unfoldAll": "Unfold all",
  "command.editor.selectToBracket": "Select to bracket",
  "command.editor.smartSelect.expand": "Expand selection",
  "command.editor.smartSelect.shrink": "Shrink selection",
  "command.editor.quickFix": "Quick fix",
  "command.editor.commentLine": "Toggle line comment",
  "command.editor.deleteLines": "Delete lines",
  "command.editor.copyFilePath": "Copy file path",
  "command.editor.fontZoomIn": "Font zoom in",
  "command.editor.fontZoomOut": "Font zoom out",
  "command.editor.fontZoomReset": "Font zoom reset",
  "command.terminal.fontZoomIn": "Terminal font zoom in",
  "command.terminal.fontZoomOut": "Terminal font zoom out",
  "command.view.toggleMinimap": "Toggle minimap",
  "command.view.toggleMaximizedPanel": "Toggle maximized panel",
  "command.view.toggleActivityBar": "Toggle activity bar",
  "command.view.toggleStatusBar": "Toggle status bar",
  "statusBar.sandbox.title": "Cloud sandbox",
  "statusBar.sandbox.tip": "Sandbox warmth: hot (studio live), warm (starting), cold (paused or idle)",
  "statusBar.sandbox.state": "Warmth",
  "statusBar.sandbox.runtime": "Runtime",
  "statusBar.sandbox.lifecycle": "Lifecycle",
  "statusBar.sandbox.costNote": "Sandboxes pause automatically when you leave Trellis Cloud to reduce compute cost.",
  "statusBar.version.tip": "turtlecode v{{version}}",
  "statusBar.version.tipPending": "turtlecode version (connecting…)",
  "command.view.moveSidebarLeft": "Move sidebar left",
  "command.view.moveSidebarRight": "Move sidebar right",
  "command.view.alignPanelCenter": "Align panel center",
  "command.view.positionPanelBottom": "Position panel bottom",
  "command.view.positionPanelRight": "Position panel right",
  "command.view.positionPanelLeft": "Position panel left",
  "command.app.quit": "Quit",
  "command.app.reload": "Reload window",
  "command.app.restart": "Restart to update",
  "command.theme.select": "Select theme",
  "command.theme.toggleLightDark": "Toggle light/dark theme",
  "command.context.addSelection": "Add selection to context",
  "command.ai.quickChat": "Quick chat",
  "command.ai.sidePane": "Open AI side pane",
  "command.ai.insertSelection": "Insert selection into chat",
  "command.ai.toggleModel": "Toggle AI model",
  "command.ai.openSettings": "Open AI settings",
  "command.ai.openGlobalRules": "Open global rules",
  "command.ai.toggleModelSelector": "Toggle model selector",
  "command.ai.switchToNextModel": "Switch to next model",
  "command.ai.openMcpMarketplace": "Open MCP marketplace",
  "command.ai.cascadeView": "Open Cascade view",
  ...
  "command.terminal.split.menu": "Terminal split options",
  "command.terminal.split.horizontal": "Split right",
  "command.terminal.split.vertical": "Split down",
  "command.terminal.pane.close": "Close pane",
  ...
  "provider.connect.openai.remoteHint":
    "On studio.trellis.computer, use ChatGPT Pro/Plus (device code). Browser sign-in only works when Studio runs locally (it completes on http://localhost:1455/auth/callback).",
  ...
  "provider.connect.toast.openaiCodex.title": "You're on ChatGPT Pro",
  "provider.connect.toast.openaiCodex.description":
    "Codex is now your default model. Nemotron 3 Super Free stays available if you switch back.",
  ...
  "dialog.newEntry.name": "Name",
  "dialog.newEntry.placeholder.file": "example.ts",
  "dialog.newEntry.placeholder.folder": "new-folder",
  "dialog.newEntry.error.empty": "Name cannot be empty",
  "dialog.newEntry.error.invalid": "Invalid path",
  ...
  "prompt.dropzone.label": "Drop files to attach them",
  ...
  "prompt.focus.pin": "Pin ambient focus",
  "prompt.focus.unpin": "Unpin ambient focus",
  "prompt.focus.exclude": "Exclude focus from next message",
  "prompt.focus.stale": "Focus may be stale — it will refresh on send",
  "prompt.focus.fork.unpromotedParent":
    "Parent lane has unpromoted Trellis changes — promote the parent separately if needed.",
  ...
  "dialog.directory.search.placeholder": "Search folders or paste a path",
  "dialog.directory.empty": "No folders found",
  "dialog.directory.openPath.header": "Paste path",
  "dialog.directory.openPath.action": "Open {{path}}",
  "dialog.directory.invalidPath": "That path is not a directory",
  "dialog.directory.create": "New project",
  "dialog.directory.create.placeholder": "Project name",
  "dialog.directory.create.action": "Create project",
  "dialog.directory.create.error": "Failed to create project",

  "dialog.clone.title": "Import from GitHub",
  "dialog.clone.description": "Paste a GitHub repository URL to clone it locally.",
  "dialog.clone.action": "Clone",
  "dialog.clone.error": "Failed to clone repository",

  "dialog.template.title": "Start with template",
  "dialog.template.action": "Create project",
  "dialog.template.loadError": "Failed to load templates",
  "dialog.template.createError": "Failed to create project from template",

  "command.project.new": "New project",
  "command.project.newBlank": "New blank project",
  "command.project.importGitHub": "Import from GitHub",
  ...
  "error.page.report.prefix": "Please report this error to the TurtleCode team",
  ...
  "session.files.selectToOpen": "Select a file to get started",
  "session.files.all": "All files",
  "session.files.empty": "No files",
  "session.files.loading": "Loading files…",
  "session.files.loadFailed": "Could not load files",
  "session.files.loadFailed.description":
    "The workspace file tree could not be read. Wait for the sandbox to finish starting, then refresh.",
  "session.files.waitingForSandbox": "Waiting for sandbox…",

  "session.fileTree.newFile": "New File",
  "session.fileTree.newFolder": "New Folder",
  "session.fileTree.expandAll": "Expand All",
  "session.fileTree.collapseAll": "Collapse All",
  "session.fileTree.refresh": "Refresh",
  "session.fileTree.contextMenu.rename": "Rename",
  "session.fileTree.contextMenu.copyPath": "Copy Path",
  "session.fileTree.contextMenu.copyPath.done": "Path copied",
  "session.fileTree.contextMenu.copyPath.failed": "Failed to copy",
  ...
  "session.threadSidebar.label": "Chat history",
  "session.threadSidebar.collapse": "Hide sidebar",
  "session.threadSidebar.expand": "Show sidebar",
  "session.threadSidebar.exitFullscreen": "Exit fullscreen",
  "session.threadSidebar.empty": "No conversations yet",
  "session.threadGroup.today": "Today",
  "session.threadGroup.yesterday": "Yesterday",
  "session.threadGroup.previous7": "Previous 7 days",
  "session.threadGroup.previous30": "Previous 30 days",
  "session.threadGroup.older": "Older",
  ...
  "session.connectOpenai.title": "Use Codex with your ChatGPT Pro or Plus subscription",
  "session.connectOpenai.description.local":
    "Connect OpenAI to use GPT-5.3 Codex with your subscription. Browser sign-in works when Studio runs locally.",
  "session.connectOpenai.description.remote":
    "Connect with device code to use GPT-5.3 Codex on studio.trellis.computer. Nemotron 3 Super Free stays the default until you connect.",
  "session.connectOpenai.action": "Connect ChatGPT",
  ...
  "session.changeDock.title.one": "1 file changed",
  "session.changeDock.title.other": "{{count}} files changed",
  "session.changeDock.collapse": "Collapse changed files",
  "session.changeDock.expand": "Expand changed files",
  "session.changeDock.accept": "Accept all",
  "session.changeDock.reject": "Reject all",

  "session.new.title": "Build anything",
  "session.tab.empty.title": "What do you want to create?",
  ...
  "session.share.popover.title": "Share session",
  ...
  "publish.action.publishNow": "Publish now",
  "publish.action.publishing": "Publishing…",
  "publish.action.live": "Live",
  "publish.action.view": "View published site",
  "publish.popover.title": "Publish to the web",
  "publish.popover.description":
    "Build your project and host a static site at a public URL on Trellis Cloud.",
  "publish.slug.label": "Site address",
  "publish.slug.hint.length": "Between 3 and 63 characters",
  "publish.slug.hint.hyphen": "Can't start or end with a hyphen",
  "publish.slug.hint.letter": "Must include at least one letter",
  "publish.slug.hint.charset": "Letters, numbers, and hyphens only",
  "publish.slug.hint.checking": "Checking availability…",
  "publish.slug.hint.available": "Available",
  "publish.slug.hint.taken": "That name is taken — try another",
  "publish.slug.hint.takenSuggestion": "Taken — try {{slug}}",
  "publish.slug.useSuggestion": "Use {{slug}}",
  "publish.slug.hint.reserved": "That name is reserved",
  "publish.plan.section": "Build settings",
  "publish.plan.loading": "Detecting build settings…",
  "publish.plan.retry": "Retry",
  "publish.plan.static": "Static site — no build step",
  "publish.plan.buildCommand": "Build command",
  "publish.plan.outputDir": "Output folder",
  "publish.plan.spaFallback": "SPA fallback (serve index.html for unknown routes)",
  "publish.visibility.label": "Visibility",
  "publish.visibility.public": "Public",
  "publish.visibility.unlisted": "Unlisted",
  "publish.visibility.publicHint": "Anyone with the link can open your site.",
  "publish.visibility.unlistedHint": "Same as public, but not listed in product surfaces.",
  "publish.menu.aria": "Publish menu",
  "publish.menu.view": "View",
  "publish.menu.copyUrl": "Copy URL",
  "publish.menu.republish": "Republish",
  "publish.menu.versions": "Versions (soon)",
  "publish.toast.success.title": "Published",
  "publish.toast.failed.title": "Publish failed",
  "publish.toast.copied.title": "URL copied",
  "publish.toast.copied.description": "Published site URL copied to clipboard",
  "publish.toast.copyFailed.title": "Could not copy URL",
  ...
  "settings.general.row.autoSaveLinks.title": "Save pasted links",
  "settings.general.row.autoSaveLinks.description":
    "Automatically add http(s) URLs from your prompts to the Design → Links library (deduped by URL)",
  ...
  "settings.shortcuts.group.app": "App",
  "settings.shortcuts.group.ai": "AI",
