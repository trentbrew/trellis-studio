export const dict = {
  ...
  "session.fileTree.newFile": "Nuevo archivo",
  "session.fileTree.newFolder": "Nueva carpeta",
  "session.fileTree.expandAll": "Expandir todo",
  "session.fileTree.collapseAll": "Contraer todo",
  "session.fileTree.refresh": "Actualizar",
