export const dict = {
  ...
  "session.fileTree.newFile": "Nouveau fichier",
  "session.fileTree.newFolder": "Nouveau dossier",
  "session.fileTree.expandAll": "Tout développer",
  "session.fileTree.collapseAll": "Tout réduire",
  "session.fileTree.refresh": "Actualiser",
