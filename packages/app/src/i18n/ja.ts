export const dict = {
  ...
  "session.tab.track": "トラック",
  "session.tab.code": "コード",
  ...
  "session.fileTree.newFile": "新規ファイル",
  "session.fileTree.newFolder": "新規フォルダ",
  "session.fileTree.expandAll": "すべて展開",
  "session.fileTree.collapseAll": "すべて折りたたむ",
  "session.fileTree.refresh": "更新",
