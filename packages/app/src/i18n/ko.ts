...
export const dict = {
  ...
  "session.fileTree.newFile": "새 파일",
  "session.fileTree.newFolder": "새 폴더",
  "session.fileTree.expandAll": "모두 펼치기",
  "session.fileTree.collapseAll": "모두 접기",
  "session.fileTree.refresh": "새로고침",
