export const dict = {
  ...
  "session.fileTree.newFile": "Nowy plik",
  "session.fileTree.newFolder": "Nowy folder",
  "session.fileTree.expandAll": "Rozwiń wszystko",
  "session.fileTree.collapseAll": "Zwiń wszystko",
  "session.fileTree.refresh": "Odśwież",
