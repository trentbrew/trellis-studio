export const dict = {
  ...
  "session.fileTree.newFile": "Новый файл",
  "session.fileTree.newFolder": "Новая папка",
  "session.fileTree.expandAll": "Развернуть все",
  "session.fileTree.collapseAll": "Свернуть все",
  "session.fileTree.refresh": "Обновить",
