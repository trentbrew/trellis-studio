export const dict = {
  ...
  "session.fileTree.newFile": "ไฟล์ใหม่",
  "session.fileTree.newFolder": "โฟลเดอร์ใหม่",
  "session.fileTree.expandAll": "ขยายทั้งหมด",
  "session.fileTree.collapseAll": "ยุบทั้งหมด",
  "session.fileTree.refresh": "รีเฟรช",
