...
export const dict = {
  ...
  "session.fileTree.newFile": "Yeni dosya",
  "session.fileTree.newFolder": "Yeni klasör",
  "session.fileTree.expandAll": "Tümünü genişlet",
  "session.fileTree.collapseAll": "Tümünü daralt",
  "session.fileTree.refresh": "Yenile",
