...
export const dict = {
  ...
  "session.fileTree.newFile": "新建文件",
  "session.fileTree.newFolder": "新建文件夹",
  "session.fileTree.expandAll": "全部展开",
  "session.fileTree.collapseAll": "全部折叠",
  "session.fileTree.refresh": "刷新",
