...
export const dict = {
  ...
  "session.fileTree.newFile": "新增檔案",
  "session.fileTree.newFolder": "新增資料夾",
  "session.fileTree.expandAll": "全部展開",
  "session.fileTree.collapseAll": "全部收合",
  "session.fileTree.refresh": "重新整理",
