...
const WorkspaceSessionList = (props: {
  ...
  <nav class="flex flex-col gap-1">
    <A
      href={`/${props.slug()}/trellis`}
      class="flex items-center gap-1 min-w-0 w-full text-left py-1 rounded-md px-2 pr-3 hover:bg-surface-raised-base-hover [&.active]:bg-surface-base-active"
      onClick={() => {
    ...
    >
      ...
      <span class="text-14-regular text-text-strong min-w-0 flex-1 truncate">Trellis Board</span>
    </A>
          ...
          >
            <div class="flex items-center gap-1">
              ...
              <WorkspaceActions
                ...
                setHoverSession={props.ctx.setHoverSession}
                clearHoverProjectSoon={props.ctx.clearHoverProjectSoon}
                createSession={() => props.ctx.createSession(props.directory)}
              />
            </div>
          </div>
        </div>
