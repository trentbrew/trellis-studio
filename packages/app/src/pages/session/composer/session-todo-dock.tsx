...
export function SessionTodoDock(props: {
  ...
  const inert = createMemo(() => props.closing === true || hide() > 0.001)
  ...
  createEffect(
    on(inert, (disabled) => {
      ...
      if (!active.closest('[data-component="session-todo-dock"]')) return
      active.blur()
    }),
  )
    ...
    >
      <div ref={contentRef}>
        <div
          ...
          classList={{
            "pl-3 pr-2 py-2 flex items-center gap-2 overflow-visible": true,
            "pointer-events-auto": !inert(),
        ...
        <div
          ...
          classList={{
            "pointer-events-none": hide() > 0.1 || inert(),
            "pointer-events-auto": hide() <= 0.1 && !inert(),
          }}
          style={{
