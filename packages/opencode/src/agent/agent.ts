        ...
        Effect.fn("Agent.state")(function* (ctx) {
          ...
          const agents: Record<string, Info> = {
            ...
            research: {
              ...
              description: `Web research agent for external investigation. Use when the task requires searching the public web, corroborating sources, or producing a cited research report — not for codebase exploration (use explore instead). Specify thoroughness: "quick" for a few targeted searches, "deep" for multi-step investigation, or "exhaustive" to delegate to deep_research for a full report.`,
