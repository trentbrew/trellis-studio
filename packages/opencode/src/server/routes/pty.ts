...
export const PtyRoutes = lazy(() =>
  new Hono()
    ...
    .get(
      "/:ptyID/image",
      describeRoute({
        summary: "Get PTY session screenshot",
        description: "Retrieve a screenshot/image of the terminal session for display in rich text contexts.",
        operationId: "pty.image",
        responses: {
          200: {
            description: "Terminal screenshot as PNG",
            content: {
              "image/png": {
      ...
      async (c) => {
        ...
        // Terminal screenshots require WebSocket connection for live content
        ...
        return c.body(transparentPixel)
      },
    )
    .put(
      "/:ptyID",
