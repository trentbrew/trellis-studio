...
export const TOAST_EVENT = "opencode:toast"
...
export function showToast(options: ToastOptions | string) {
  ...
  const text = [opts.title, opts.description].filter((part): part is string => !!part).join(": ")
  if (text && typeof window !== "undefined")
    window.dispatchEvent(new CustomEvent(TOAST_EVENT, { detail: { title: opts.title, description: opts.description } }))
