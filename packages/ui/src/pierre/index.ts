...
[data-file] {
  ...
  --diffs-selection-base: var(--border-interactive-base);
  --diffs-selection-border: var(--border-interactive-base);
  --diffs-selection-number-fg: var(--text-base);
  /* Use explicit alpha instead of color-mix(..., transparent) to avoid Safari's non-premultiplied interpolation bugs. */
  --diffs-bg-selection: var(--diffs-bg-selection-override, var(--surface-base-interactive-active));
  --diffs-bg-selection-number: var(
    --diffs-bg-selection-number-override,
    var(--surface-base-interactive-active)
  );
  --diffs-bg-selection-text: var(--surface-base-interactive-active);
}
