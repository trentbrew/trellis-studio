/**
 * Vendored from fractional-indexing@3.2.0 (CC0).
 * Inlined so Vite can load @opencode-ai/whiteboard source via @fs without a
 * separate node_modules install under packages/whiteboard.
 */
