...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/trentbrew/trellis-studio/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for trentbrew/trellis-studio...\n")
